...
def test_find_element_by_image_one_element_click_with_offset(selenium, website):
    selenium.get(urljoin(website, "/browsers.htm"))
    element = selenium.find_element_by_image("tests/html/browser_edge.png")
    element.click(-100, 200)
    assert (
...
def test_find_element_by_image_one_element_move_to_with_offset(selenium, website):
    selenium.get(urljoin(website, "/browsers.htm"))
    element = selenium.find_element_by_image("tests/html/browser_edge.png")
